      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          <tr className="border-b border-wire">
            <th className="text-left py-2 pr-4 text-ink-muted font-medium">Operation</th>
            <th className="text-left py-2 pr-4 text-ink-muted font-medium">Time</th>
            <th className="text-left py-2 pr-4 text-ink-muted font-medium">Space</th>
            <th className="text-left py-2 text-ink-muted font-medium">Notes</th>
          </tr>
        </thead>
        <tbody>
          {entries.map((entry, i) => (
