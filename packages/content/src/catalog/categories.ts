...
export const categories: CategoryDefinition[] = [
  {
    ...
    summary: "Data structures that come up constantly in real systems — probabilistic filters, caches, tries, and more.",
    order: 1,
  },
  {
    ...
    summary: "Coordination, consistency, and resilience patterns for systems that span multiple nodes.",
    order: 2,
  },
  {
    id: "messaging",
    contentAreaId: "backend-systems",
    title: "Messaging",
    summary: "Patterns for reliable, ordered, and scalable communication between services via queues and streams.",
    order: 3,
  },
  {
    id: "caching",
